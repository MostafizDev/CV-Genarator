  ...
  return (
    <div className="bg-white rounded-2xl border border-slate-200 shadow-xs overflow-hidden">
      ...
      <div className="p-6 max-h-[600px] overflow-y-auto">
        {viewMode === 'json' ? (
          <pre className="text-xs font-mono bg-slate-900 text-green-400 p-4 rounded-xl overflow-x-auto whitespace-pre-wrap">
          ...
          <div className="space-y-6 text-slate-800 text-sm">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 bg-slate-50 p-3 rounded-lg border border-slate-200">
                <input
                  ...
                  className="sm:col-span-2 font-semibold text-sm px-2 py-1.5 rounded border border-transparent hover:border-slate-200 focus:border-blue-500 focus:outline-none transition bg-white"
                />
                <input
                  type="text"
                  value={cv.email || ''}
                  ...
                  placeholder="Email"
                  className="text-xs px-2 py-1.5 rounded border border-transparent hover:border-slate-200 focus:border-blue-500 focus:outline-none transition bg-white"
                />
                <input
                  type="text"
                  value={cv.phone || ''}
                ...
                <input
                  ...
                  className="sm:col-span-2 text-xs px-2 py-1.5 rounded border border-transparent hover:border-slate-200 focus:border-blue-500 focus:outline-none transition bg-white"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full text-xs sm:text-sm leading-relaxed bg-blue-50/50 p-3 rounded-lg border border-blue-100 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition"
              />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full text-xs bg-slate-50 p-3 rounded-lg border border-slate-200 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition"
              />
            </div>
              ...
              <div>
                ...
                <div className="space-y-4">
                  {cv.experience.map((exp: any, i: number) => (
                    <div key={i} className="border-l-2 border-blue-400 pl-3.5 space-y-2">
                      <div className="grid grid-cols-2 gap-2">
                        <input
                          ...
                          className="font-semibold text-slate-900 text-sm px-2 py-1 rounded border border-transparent hover:border-slate-200 focus:border-blue-500 focus:outline-none transition bg-transparent"
                        />
                        <input
                          type="text"
                          value={exp.company || ''}
                          ...
                          placeholder="Company"
                          className="text-xs font-medium text-blue-700 px-2 py-1 rounded border border-transparent hover:border-slate-200 focus:border-blue-500 focus:outline-none transition bg-transparent"
                        />
                        <input
                          type="text"
                          ...
                          className="text-xs text-slate-500 px-2 py-1 rounded border border-transparent hover:border-slate-200 focus:border-blue-500 focus:outline-none transition bg-transparent"
                        />
                        <input
                          type="text"
                          value={exp.end_date || ''}
                      ...
                      <textarea
                        ...
                        className="w-full text-xs text-slate-600 leading-relaxed bg-slate-50 p-2.5 rounded-lg border border-slate-200 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition"
                      />
                    </div>
                  ))}
                </div>
                  ...
                  {cv.projects.map((proj: any, i: number) => (
                    <div key={i} className="p-3 bg-slate-50 rounded-lg border border-slate-200/80 text-xs space-y-1.5">
                      <input
                        ...
                        className="font-semibold text-slate-900 w-full px-2 py-1 rounded border border-transparent hover:border-slate-200 focus:border-blue-500 focus:outline-none transition bg-transparent"
                      />
                      <input
                        type="text"
                        ...
                        className="text-slate-500 text-[11px] w-full px-2 py-1 rounded border border-transparent hover:border-slate-200 focus:border-blue-500 focus:outline-none transition bg-transparent"
                      />
                      <textarea
                        rows={2}
                        ...
                        className="text-slate-600 leading-relaxed w-full px-2 py-1.5 rounded border border-transparent hover:border-slate-200 focus:border-blue-500 focus:outline-none transition bg-transparent"
                      />
                    </div>
                  ))}
                </div>
                    ...
                    {cv.certifications.map((c: any, i: number) => (
                      <div key={i} className="text-xs text-slate-700 bg-slate-50 p-2 rounded border border-slate-100 space-y-1">
                        <input
                          ...
                          className="font-medium w-full px-1.5 py-0.5 rounded border border-transparent hover:border-slate-200 focus:border-blue-500 focus:outline-none transition bg-transparent"
                        />
                        <div className="flex gap-1.5">
                          <input
                            ...
                            placeholder="Issuer"
                            className="text-[11px] text-slate-500 w-full px-1.5 py-0.5 rounded border border-transparent hover:border-slate-200 focus:border-blue-500 focus:outline-none transition bg-transparent"
                          />
                          <input
                            type="text"
                            value={c.date_earned || ''}
                            ...
                            placeholder="Date"
                            className="text-[11px] text-slate-500 w-24 shrink-0 px-1.5 py-0.5 rounded border border-transparent hover:border-slate-200 focus:border-blue-500 focus:outline-none transition bg-transparent"
                          />
                        </div>
                      </div>
                    ))}
                      ...
                      <div key={i} className="text-xs text-slate-700 bg-slate-50 p-2 rounded border border-slate-100 space-y-1">
                        ...
                        <div className="flex gap-1.5">
                          ...
                          <input
                            ...
                            placeholder="Year"
                            className="text-[11px] text-slate-500 w-20 shrink-0 px-1.5 py-0.5 rounded border border-transparent hover:border-slate-200 focus:border-blue-500 focus:outline-none transition bg-transparent"
                          />
                        </div>
                      </div>
                    ))}
